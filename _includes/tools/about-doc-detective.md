[Doc Detective](https://doc-detective.com) is an open-source, MIT-licensed documentation testing framework. Doc Detective has multiple components to integrate with your workflows as you need it to:
...
Doc Detective is open to contributions, and you can join the chat on [Discord](https://discord.com/invite/sgnE22uZ9w). If you like what you see, you can ⭐ the repositories on GitHub or donate to support development via [Ko-fi](https://ko-fi.com/hawkeyexl).
